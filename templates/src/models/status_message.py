...
class StatusMessage(str, enum.Enum):
    ...
    DATASET_COULD_NOT_BE_READ = "message.pipeline.error.dataset_could_not_be_read"
    DATASET_COULD_NOT_BE_LOADED = "message.pipeline.error.dataset_could_not_be_loaded"
