...
def get_databag_by_id(databag_id: str, os4ml_namespace: str) -> Databag:
...
def update_databag(databag: Databag, os4ml_namespace: str) -> None:
    model_manager = init_model_manager_client(os4ml_namespace)
...
def update_databag_status(
    databag_id: str, status: str, os4ml_namespace: str
) -> Databag:
    model_manager = init_model_manager_client(os4ml_namespace)
...
def update_databag_error_status(
    databag_id: str, error_msg_key: ErrorMsgKey, os4ml_namespace
) -> None:
    model_manager = init_model_manager_client(os4ml_namespace)
    databag = model_manager.get_databag_by_id(databag_id, usertoken=USER_TOKEN)
...
def get_dataset_download_url(databag: Databag, os4ml_namespace: str) -> str:
    model_manager = init_model_manager_client(os4ml_namespace)
...
def get_dataframe_download_url(databag: Databag, os4ml_namespace: str) -> str:
    model_manager = init_model_manager_client(os4ml_namespace)
...
def upload_dataframe(
    dataframe: IO[bytes], databag: Databag, os4ml_namespace: str
) -> None:
    model_manager = init_model_manager_client(os4ml_namespace)
