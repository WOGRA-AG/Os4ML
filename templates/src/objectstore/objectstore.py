...
def download_file_from_bucket(
    ...
    url = f"http://objectstore-manager.os4ml:8000/apis/v1beta1/objectstore/{bucket}/object?objectName={file_name}"
    with open(output_file_name, "wb") as output_file:
        download_file(url, output_file)


def download_databag_from_bucket(bucket: str) -> Dict:
    url = f"http://objectstore-manager.os4ml:8000/apis/v1beta1/objectstore/databag/{bucket}"
