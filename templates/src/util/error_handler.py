...
from model.error_msg_keys import ErrorMsgKeys
from objectstore.objectstore import error_databag_status_update


def error_handler(error_msg_key=ErrorMsgKeys.DEFAULT):
