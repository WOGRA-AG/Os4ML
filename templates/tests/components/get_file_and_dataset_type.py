...
from components.get_file_and_dataset_type import file_type_from_file_name, dataset_type_from_file_name
...
@pytest.mark.parametrize(('file_name', 'file_type'), (
    ...
    ("https://gist.githubusercontent.com/f/2/raw/3/titanic_dataset.csv", FileType.CSV),
